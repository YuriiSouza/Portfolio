  ...
  return (
    <section id="case-studies" className="py-10 pt-20">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-3xl font-bold">Estudos de Caso</h2>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="relative h-64 lg:h-auto overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-6">
                <div>
                  ...
                  <h3 className="text-2xl font-bold">Análise de processos internos.</h3>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <p className=" mb-4">Desenvolvi um sistema integrado que automatizou:</p>
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="">Com os resultados claros, ficou mais fácil criar estratégias para corrigir as falhas nos processos.</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-green-900/20 border border-green-800/30 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm">Processos Otimizados e Redução de Falhas</p>
                  </div>
                  ...
                  <div className="bg-blue-900/20 border border-blue-800/30 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm">Aumento da Produtividade e Qualidade</p>
                  </div>
